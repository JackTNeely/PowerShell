# Source folder to search for files matching file name - modify this as needed
$SourceFolder = "C:\"

# Specify destination folder to copy files for backup - modify this as needed
$DestinationFolder = "$env:userprofile\Desktop\Backups"

# Specify file name to backup - modify this as needed
